...
export default function GuineaMap({ searchParams }: { searchParams: { userId?: string } }) {
  const userId = searchParams.userId
  const { config, isLoading } = useCountryProjection("Guinea", geoUrl)

  if (isLoading) {
    return (
      <CountryMapLayout countryName="Guinea" userId={userId}>
