...
export default function JapanMapPage() {
  ...
  const { config, isLoading } = useCountryProjection("Japan", geoUrl)

  if (isLoading) {
    return (
      <CountryMapLayout countryName="Japan" userId={userId}>
      ...
      <div className="w-full h-full flex items-center justify-center">
        ...
        >
          <Geographies geography={geoUrl}>
            {({ geographies }) =>
              geographies.map((geo) => {
                const regionName = geo.properties.NAME_1 || "Unknown"
