                      ...
                      <div className="aspect-[9/16] rounded-t-lg overflow-hidden bg-muted">
                        ...
                        <div className="absolute top-3 left-1/2 -translate-x-1/2 flex items-center z-10 backdrop-blur-sm rounded-full bg-transparent gap-1.5 p-0.5 mt-[-7px]">
                          ...
                          <button
                            ...
                            className="group/trash rounded-full bg-transparent backdrop-blur-sm transition-all duration-300 hover:scale-110 active:scale-110 shadow-lg hover:shadow-[inset_0_2px_8px_rgba(255,255,255,0.2)] bg-transparent p-2.5"
                          >
                            <Trash2 className="text-white size-6 transition-colors duration-300 group-hover/trash:text-green-500 group-active/trash:text-green-500" />
                          </button>
                        </div>
                    ...
                    <div className="relative">
                      <div className="aspect-[9/16] rounded-t-lg overflow-hidden bg-muted">
                        ...
                        <button
                          ...
                          className={`group/photoSelect absolute top-3 left-3 z-10 rounded-full bg-transparent backdrop-blur-sm transition-all duration-300 hover:scale-110 active:scale-110 shadow-lg p-2 ${
                            isSelected
                              ? "hover:shadow-[inset_0_2px_12px_rgba(253,180,132,0.5)]"
                              : "hover:shadow-[inset_0_2px_8px_rgba(255,255,255,0.2)]"
                          }`}
                        >
                          <div
                            className={`rounded-full border-2 flex items-center justify-center transition-colors duration-300 size-6 ${
                              isSelected
                                ? "bg-[#FDB484] border-[#FDB484]"
