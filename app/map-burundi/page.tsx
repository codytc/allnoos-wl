...
export default function BurundiMap({ searchParams }: { searchParams: { userId?: string } }) {
  const userId = searchParams.userId
  const { config, isLoading } = useCountryProjection("Burundi", geoUrl)

  if (isLoading) {
    return (
      <CountryMapLayout countryName="Burundi" userId={userId}>
