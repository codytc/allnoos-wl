        ...
        <div className="relative bg-gradient-to-r from-white/15 via-white/25 to-white/15 backdrop-blur-xl rounded-full flex items-center border border-white/30 p-2 shadow-2xl mb-[-20px] gap-0 px-0.5 py-1">
          ...
          <div className="flex items-center gap-4 px-2 mt-2 mb-[-25px]">
            ...
            >
              ...
              <UserSquareIcon className="w-6 h-6 drop-shadow-lg relative z-10 text-white" />
            </button>
            ...
            <button className="w-12 h-12 flex items-center justify-center active:bg-white/30 transition-all duration-200 active:scale-95 rounded-full border border-white/20 hover:bg-white/20 relative">
              <div className="absolute inset-1 rounded-full bg-gradient-to-b from-white/20 to-transparent pointer-events-none"></div>
              <MessageSquareIcon width="24" height="24" className="text-white" strokeWidth={2} />
            </button>
            ...
            >
              <div className="absolute inset-1 rounded-full bg-gradient-to-b from-white/20 to-transparent pointer-events-none"></div>
              {flashEnabled ? (
                <ZapOff className="w-6 h-6 text-white drop-shadow-lg relative z-10" />
              ) : (
