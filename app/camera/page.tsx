          ...
          {showCreateButton && (
            <div className="absolute top-[-60px] left-1/2 transform -translate-x-1/2 z-10">
              <Link href="/create" className="flex items-center justify-center">
                <button className="bg-gradient-to-br from-orange-400/30 to-orange-600/30 backdrop-blur-md active:from-orange-500/40 active:to-orange-700/40 transition-all duration-200 active:scale-95 rounded-full flex items-center justify-center shadow-lg border border-orange-300/30 relative z-10 w-28 font-medium h-7 px-4 mb-0 mt-[68px]">
