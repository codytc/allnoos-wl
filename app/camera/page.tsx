      ...
      <div className="absolute top-0 left-0 right-0 z-50 flex items-end px-6 py-4 text-white justify-center">
        <div className="flex-1 flex justify-start">
          ...
          >
            ...
            <ChevronLeftIcon className="size-5 relative z-10 text-white opacity-90" />
          </button>
        </div>
            ...
            <div className="absolute top-[-60px] left-1/2 transform -translate-x-1/2 z-10 mt-[68px]">
              ...
              {showDefinition && definitions[phrases[phraseIndex]] && (
                <div className="absolute left-1/2 -translate-x-1/2 bottom-14">
                  <p className="text-white/80 drop-shadow-lg text-xs leading-relaxed w-[240px] text-left">
