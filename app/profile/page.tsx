...
import { ArrowLeft, MapPin, Calendar, Send, X, Flame } from "lucide-react"
      ...
      <div className="sticky top-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border">
        <div className="p-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex-1 flex justify-end">{/* Empty space for balance */}</div>
          </div>
        </div>
      </div>
      ...
      <div className="p-6">
        ...
        <div className="px-4 pb-6">
          <div className="flex gap-3 w-full">
            <Link href="/profile/about" className="flex-1">
              <Button variant="outline" className="w-full bg-transparent py-4 px-6 text-base font-medium">
                About
              </Button>
            </Link>
            {isFollowing ? (
