  ...
  return (
    ...
    >
      <svg width="0" height="0" className="absolute">
        <defs>
          <clipPath id="headerCurveClipUserProfile" clipPathUnits="objectBoundingBox">
            <path d="M 0,0 L 1,0 L 1,0.733 C 0.861,0.822 0.639,0.822 0.5,0.733 C 0.361,0.651 0.139,0.651 0,0.733 Z" />
          </clipPath>
        </defs>
      </svg>

      <div className="sticky top-0 z-50 bg-background" style={{ clipPath: "url(#headerCurveClipUserProfile)" }}>
          ...
          <div className="flex-1 flex justify-center">
            <Link href="/feed">
              <div className="relative flex items-center justify-center h-12 px-8">
                <div className="absolute top-[-18px] left-[50%] transform translate-x-[15px] z-10 text-xs tracking-tighter my-[22px] mb-0 mt-0 mr-0 ml-[-8px] italic">
        ...
        <div className="w-full h-8 relative -mb-8 flex items-end z-30" style={{ transform: "translateY(-18px)" }}>
          ...
          >
            <defs>
              <linearGradient id="curvedLineGradientUserProfile" x1="0%" y1="100%" x2="100%" y2="0%">
            ...
            <path
              ...
              stroke="url(#curvedLineGradientUserProfile)"
              strokeWidth="2.5"
              fill="none"
            />
          </svg>
      ...
      {/* CRITICAL: This dropdown MUST render at the END of the component JSX to avoid being clipped by header's clipPath */}
      {/* DO NOT move back inside header or any container with clipPath applied */}
      {showSettingsDropdown && (
        <div className="fixed right-4 top-16 w-56 bg-white/95 backdrop-blur-md rounded-xl shadow-2xl border border-white/30 py-2 z-[9999] animate-in slide-in-from-top-2 duration-200">
          <button
            onClick={() => handleSettingsOptionSelect("notifications")}
          ...
          >
            ...
            <span className="text-xs text-red-600 bg-red-50 px-2 py-1 rounded-full font-medium">3 new</span>
          </button>
          <button
          ...
          >
            ...
            <span className="text-xs text-green-600 bg-green-50 px-2 py-1 rounded-full font-medium">$2.3k</span>
          </button>
          <button
          ...
          >
            ...
            <span className="text-xs text-purple-600 bg-purple-50 px-2 py-1 rounded-full font-medium">Active</span>
          </button>
        </div>
      )}
    </div>
