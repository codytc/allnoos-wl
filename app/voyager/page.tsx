      ...
      <svg width="0" height="0" className="absolute">
        <defs>
          <clipPath id="headerCurveClipVoyager" clipPathUnits="objectBoundingBox">
            <path d="M 0,0 L 1,0 L 1,0.846 C 0.861,0.926 0.639,0.926 0.5,0.8465 C 0.361,0.768 0.139,0.768 0,0.848 Z" />
          </clipPath>
        </defs>
      </svg>
      ...
      <div className="sticky top-0 z-50 bg-background" style={{ clipPath: "url(#headerCurveClipVoyager)" }}>
        ...
        <div className="w-full h-8 relative -mb-6">
          ...
          >
            ...
            <path
              d="M 0,40 C 200,10 520,10 720,40 C 920,70 1240,70 1440,40"
