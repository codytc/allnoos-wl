...
export default function SpainMapPage({
  ...
  const geoUrl = "https://raw.githubusercontent.com/codeforamerica/click_that_hood/master/public/data/spain.geojson"

  const { config, isLoading } = useCountryProjection("Spain", geoUrl)
  ...
  if (isLoading || !config) {
    return (
      <CountryMapLayout countryName="Spain" userId={userId}>
