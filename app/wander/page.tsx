          ...
          >
            <div className="flex gap-3 pb-2">
              {featuredJournalists.map((journalist) => {
                ...
                return (
                  <Link key={journalist.id} href={`/user-profile?id=${journalist.id}`}>
                    <Card
                    ...
                    >
                      ...
                      <div className="relative h-56 flex-shrink-0">
                        ...
                        <div className="absolute bottom-4 right-4 flex items-center gap-2 px-3 border border-primary/20 rounded-lg bg-background/90 backdrop-blur-sm shadow-sm z-20 py-1">
